...
| `scripts/` | Supported | Health checks, summaries, evaluation, registry validation, heatmap reports, annotation exports, weapon training CLIs, and training planning. |
