...
from src.heatmap.annotation_round import annotation_progress, evaluate_progress_gates, resolve_round


def write_rows(path: Path, rows: list[dict[str, str]]) -> None:
    fieldnames = ["match_id", "time", "frame_index", "team", "x", "y", "visibility", "frame_complete"]
